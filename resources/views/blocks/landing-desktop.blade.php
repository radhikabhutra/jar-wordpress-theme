...
<div class="block-visibility-wrapper" data-block-visibility="desktop">
    <header
        class="sticky top-0 z-30 w-full bg-white py-6 px-[120px] gap-[320px] mx-auto flex justify-center items-center">
            ...
            @if (get_field('field_hero_video_url'))
                <div class="w-full max-w-5xl">
                    <div class="!aspect-[16/9] w-full h-full overflow-hidden">
                        <iframe src="{{ get_field('field_hero_video_url') }}" title="YouTube video player"
                            frameborder="0"
